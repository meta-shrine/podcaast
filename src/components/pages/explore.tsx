          ...
          <div
            ...
            <div className=' text-neutral-300 z-10'>
              ...
              <div
                ...
                <button onClick={(e)=>{e.stopPropagation()}} className='h-12 z-50 border-neutral-500 bg-neutral-700/50 rounded-full px-6 flex gap-4 items-center hover:bg-neutral-600/50 group ease-in-out duration-200'>
                  <FaPlay
                    className='text-neutral-500 group-hover:text-neutral-400  group-hover:scale-110 ease-in-out duration-200'
                    size='20'
                  />
