  ...
  return (
    <div className='h-full w-full'>
      <div className='flex flex-col gap-4'>
        ...
        <div ref={scrollref} className='flex min-w-full gap-4 overflow-x-scroll'>
          {[1, 2, 3, 4, 5].map((items, idx) => (
            <div
              key={idx}
              draggable
              className='h-56 min-w-[24rem] scroll-smooth border border-neutral-800 rounded-lg overflow-hidden relative z-0'>
